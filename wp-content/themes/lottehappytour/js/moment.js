(function($) {
    ...
    $(function() {
		...
		$('.group .container-slide-video').on('click','li',function(){
			...
			html = '<div class="video-warp" > <iframe width="100%" height="610px" src="https://www.youtube.com/embed/'+data.vid+'?autohide=1&modestbranding=1&showinfo=0" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div> <div class="video-bar"></div> <div class="video-des"> <h3>'+title+'</h3><p class="desc">'+desc+'</p></div>';
