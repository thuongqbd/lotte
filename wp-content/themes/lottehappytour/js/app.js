    ...
    $(function() {
		$('.happy-moment-slider .jcarousel li').on('click',function(event){
			...
			if(!$(this).closest('.group.happy-moment-wp').hasClass('spirit')){
				...
				html = '<iframe width="100%" height="450px" src="https://www.youtube.com/embed/'+data.vid+'?autohide=1&modestbranding=1&showinfo=0" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
